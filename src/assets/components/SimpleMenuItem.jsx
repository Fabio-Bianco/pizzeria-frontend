...
function SimpleMenuItem({
  ...
  return (
    <li className="simple-menu-item" style={{display:'flex',flexDirection:'row',alignItems:'stretch',gap:'1.5em',padding:'1.2em 0',borderBottom:'1px solid #f3f3f3',position:'relative',background:'#fff',minHeight:90}}>
      <div style={{flexShrink:0,display:'flex',flexDirection:'column',alignItems:'flex-start',height:'100%',justifyContent:'flex-start',minWidth:64,gap:'1.5em',position:'relative'}}>
        <div style={{position:'relative', width:64, height:64}}>
          ...
          {/* Badge Gluten Free in basso a sinistra sotto l'immagine */}
          {is_gluten_free && (
            <span
